...
const MONGODB_URI = process.env.MONGODB_URI || `mongodb+srv://BloodHub-USER:XYjt0h0CMZbAlFzg@cluster0.0qtlc.mongodb.net/TaskManagerDB`; // Replace with your actual URI

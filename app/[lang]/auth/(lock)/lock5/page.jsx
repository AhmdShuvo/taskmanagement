            ...
            <div className="basis-full xl:basis-1/2 hidden xl:block relative w-[500px] ">
              ...
              <div className="bg-primary h-full w-full rounded-3xl rounded-tr-none  xl:p-[60px] xl:pr-9 relative  overflow-hidden">
                ...
                <div className="text-xl  mt-2 text-primary-foreground flex gap-1 rtl:pr-12">
                  ...
                  Task Maneger is awesome friendly Admin Dashboard Template. If you
                  manage your business in online then “Task Maneger” is for you. Buy
...
//                   Task Maneger is awesome friendly Admin Dashboard Template. If you manage your business in online then “Task Maneger” is for you. Buy Now & make user friendly your business today...
//                 </div>

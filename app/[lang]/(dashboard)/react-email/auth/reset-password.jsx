...
import ManegerLogo from "@/public/images/logo/logo-2.png"
          ...
          <Container style={container}>
            ...
            <Section>
              ...
              <Text className="mt-4 text-sm text-slate-900 px-10">
                Thanks, <br />
                The Task Maneger Team
              </Text>
            </Section>
            <Text className="border border-gray-100 mx-10 mt-7"></Text>
            <Text className="px-10 text-sm text-gray-900 mt-5">Sent with ❤️ from Task Maneger </Text>
